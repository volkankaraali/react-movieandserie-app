...
function Top250Movies() {
    const { top250Movies } = useSelector(state => state.movies);
    ...
    useEffect(() => {
        ...
        const { currentPosts, totalPages } = usePagination(top250Movies, currentPage, postPerPage);
        setData(currentPosts);
        setPages(totalPages)
    }, [postPerPage, currentPage, top250Movies]);

    const handlePageChange = (event, value) => setCurrentPage(value);

    return (
        <Page title='Movies | Top 250 '>
